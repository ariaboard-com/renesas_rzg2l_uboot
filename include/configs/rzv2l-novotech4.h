...
#define CONFIG_MAX_MEM_MAPPED         (0x100000000u - DRAM_RSV_SIZE)
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcload=fatload mmc 0:1 0x48080000 Image;fatload mmc 0:1 0x48000000 r9a07g054l2-rzv2l-novotech.dtb;run prodemmcbootargs \0" \
	"sd1load=fatload mmc 1:1 0x48080000 Image;fatload mmc 1:1 0x48000000 r9a07g054l2-rzv2l-novotech.dtb;run prodsdbootargs \0" \
	"sdboot=run sd1load;run bootimage \0" \
	"emmcboot=run emmcload;run bootimage \0"
